...
[![views](https://komarev.com/ghpvc/?username=leftger&style=flat&color=313131&label=views&abbreviated=true)](https://github.com/leftger)
...
I joined GitHub **14** years ago and have since pushed **1340** commits, opened **27** issues, submitted **219** pull requests, and earned **44** stars across **28** personal projects, with contributions to **26** public repositories.

I'm currently on a **20**-day commit streak.

#### 🛠️ What am I working on?

| Category | Focus & Description |
| :--- | :--- |
| **Maintaining** | [**Embassy**](https://github.com/embassy-rs/embassy) & [**`stm32-data`**](https://github.com/embassy-rs/stm32-data) – STM32 HAL/PAC, silicon bringup (**STM32N6**, **U5**, **H7R/S**, **C5**, **WBA**), and ported/maintain the **STM32WBA BLE stack**. |
| **Architecting** | Foundational zero-allocation (`no_std`) engines for Cortex-M: [`embedded-gui`](https://github.com/leftger/embedded-gui), [`embedded-3dgfx`](https://github.com/leftger/embedded-3dgfx), [`embedded-dsp`](https://github.com/leftger/embedded-dsp), [`embedded-audio`](https://github.com/leftger/embedded-audio), [`embedded-nn`](https://github.com/leftger/embedded-nn). |
| **Advocating** | Declarative type-safe peripheral drivers via [@diondokter](https://github.com/diondokter)'s [`device-driver`](https://github.com/diondokter/device-driver) crate for bit-level register modeling. |
| **Bootstrapping** | Automated, idempotent Linux & embedded Rust workstation provisioning via [**`leftger.github.io`**](https://leftger.github.io). |
...
<div align="right">
  <b>~</b> <a href="https://leftger.github.io"><i>leftger.github.io</i></a>
</div>
